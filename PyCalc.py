...
class Calculator:
    ...
    def __init__(self, root):
        ...
        self.button0 = ttk.Button(root, text="0", command=lambda: self.button_press('0')).grid(row=1, column=3)
        ...
        self.button_clear = ttk.Button(root, text="AC", command=lambda: self.button_press('AC')).grid(row=2, column=3)
        ...
        self.button_equal = ttk.Button(root, text="=", command=lambda: self.equal_button_press()).grid(row=3, column=3)

        # ----- 4th Row -----

        self.button_add = ttk.Button(root, text="+", command=lambda: self.math_button_press('+')).grid(row=4, column=0)

        self.button_mult = ttk.Button(root, text="*", command=lambda: self.math_button_press('*')).grid(row=4, column=1)

        self.button_sub = ttk.Button(root, text="-", command=lambda: self.math_button_press('-')).grid(row=4, column=2)
